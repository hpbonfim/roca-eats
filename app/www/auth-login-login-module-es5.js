...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-login-login-module"], {
  ...
  function srcAppAuthLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    LoginPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _login_routing_module__WEBPACK_IMPORTED_MODULE_6__["LoginPageRoutingModule"]],
  ...
  function srcAppAuthLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_models_loginData_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/models/loginData.model */
    "./src/app/models/loginData.model.ts");

    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(alertController, authService, router) {
        ...
        this.subtituloProjeto = "Queremos diminuir o impacto que o novo coronavirus COVID-19 está fazendo em nossas vidas."; // textos footer
      ...
      _createClass(LoginPage, [{
        ...
        value: function login() {
          ...
          this.authService.login(this.loginData.email, this.loginData.password).subscribe(function (res) {
            if (res["success"] == false) {
              _this.presentAlert('Login', res["message"]);
            } else if (res["success"] == true) {
              localStorage.setItem("user", _this.loginData.email);
              window.location.href = 'http://ec2-52-67-30-15.sa-east-1.compute.amazonaws.com/dashboard';
            } else {
              _this.presentAlert('Login', "Seus dados de login estão incorretos, verifique!");
            }
          });
        }
      }, {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["AlertController"], src_app_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])], LoginPage);
    /***/
  },
  ...
  /***/
  function srcAppModelsLoginDataModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoginData", function () {
      return LoginData;
    });
    /* harmony import */
