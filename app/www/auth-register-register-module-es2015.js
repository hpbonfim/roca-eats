...
/* harmony import */ var src_app_services_auth_user_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/auth/user.services */ "./src/app/services/auth/user.services.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _models_address_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../models/address.model */ "./src/app/models/address.model.ts");
...
/* harmony import */ var src_app_services_auth_user_services__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/auth/user.services */ "./src/app/services/auth/user.services.ts");
/* harmony import */ var src_app_providers_viacep_provider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/providers/viacep.provider */ "./src/app/providers/viacep.provider.ts");
/* harmony import */ var src_app_providers_openstreetmap_provider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/providers/openstreetmap.provider */ "./src/app/providers/openstreetmap.provider.ts");
/* harmony import */ var src_app_providers_ibge_provider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/providers/ibge.provider */ "./src/app/providers/ibge.provider.ts");
...
let RegisterPage = class RegisterPage {
    constructor(alertController, ibgeProvider, userService, viaCep, openStreetMap, router) {
    ...
    getAddress() {
        if (this.address.postalCode != null) {
            this.viaCep.callService(this.address.postalCode)
                ...
                this.openStreetMap.callService(`${this.address.address}, ${this.address.neighborhood}, ${this.address.city}, ${this.address.state}, brasil`).subscribe(data => {
                    if (data) {
